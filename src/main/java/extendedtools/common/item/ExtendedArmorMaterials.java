...
public enum ExtendedArmorMaterials {
    ...
    STEEL(40, new int[] { 3, 5, 7, 3 }, 10, 1, 0, Tags.INGOT_STEEL, "steel"),
    BRONZE(20, new int[] { 2, 5, 6, 2 }, 10, 0, 0, Tags.INGOT_BRONZE, "bronze"),
    TIN(12, new int[] { 2, 4, 5, 2 }, 10, 0, 0, Tags.INGOT_TIN, "tin"),
    COPPER(17, new int[] { 2, 4, 5, 2 }, 10, 0, 0, net.neoforged.neoforge.common.Tags.Items.INGOTS_COPPER, "copper"),
    LEAD(33, new int[] { 2, 4, 5, 2 }, 10, 0, 3, Tags.INGOT_LEAD, "lead"),
    VANADIUM(22, new int[] { 3, 4, 5, 3 }, 10, 0, 0, Tags.INGOT_VANADIUM, "vanadium"),
    SILVER(27, new int[] { 3, 5, 7, 3 }, 10, 0, 0, Tags.INGOT_SILVER, "silver"),
    TITANIUM(75, new int[] { 4, 6, 8, 4 }, 10, 2, 0, Tags.INGOT_TITANIUM, "titanium");
    ...
    private ExtendedArmorMaterials(int maxDamageFactor, int[] dmgArray, int enchantability, float toughness,
	    float knockbackResistance, TagKey<Item> repairIng, String name) {
